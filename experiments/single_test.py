...
def test_simulation():
    ...
    avg_score, iteration = simulate_environment(N, D, decision_function=greedy_decision, belief_update_function=mean_update, observation_radius=0, communication_radius=1000, num_adversarial=0, distance_to_origin_weight= 5, epsilon=0) 
